    ...
    <div>
      ...
      <div className="card">
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '24px' }}>
          ...
          <div>
            <p style={{ color: 'var(--text-secondary)', fontSize: '0.875rem', marginBottom: '4px' }}>Cidade</p>
            <p style={{ fontWeight: 500 }}>{lead.cidade || '-'}</p>
          </div>
          <div>
          ...
          <div>
            <p style={{ color: 'var(--text-secondary)', fontSize: '0.875rem', marginBottom: '4px' }}>Consentimento WhatsApp</p>
            <p style={{ fontWeight: 500 }}>{lead.consentimento_whatsapp ? 'Sim' : 'Não / Não informado'}</p>
          </div>
          <div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '24px' }}>
          ...
          <div>
            <p style={{ color: 'var(--text-secondary)', fontSize: '0.875rem', marginBottom: '4px' }}>Comprovação de Renda</p>
            <p style={{ fontWeight: 500 }}>{lead.comprovacao_renda || '-'}</p>
          </div>
          <div>
            <p style={{ color: 'var(--text-secondary)', fontSize: '0.875rem', marginBottom: '4px' }}>Tempo de Renda</p>
            <p style={{ fontWeight: 500 }}>{lead.tempo_renda || '-'}</p>
          </div>

          <div style={{ gridColumn: '1 / -1' }}>
            <p style={{ color: 'var(--text-secondary)', fontSize: '0.875rem', marginBottom: '4px' }}>Observações e Finalidade</p>
            <div style={{ backgroundColor: 'var(--bg-color)', padding: '16px', borderRadius: 'var(--radius-md)', marginTop: '8px' }}>
              <p style={{ lineHeight: '1.6', whiteSpace: 'pre-wrap' }}>{lead.observacoes || 'Nenhuma observação extra.'}</p>
            </div>
          </div>
        </div>

        <h3 style={{ marginBottom: '24px', marginTop: '40px', borderBottom: '1px solid var(--border-color)', paddingBottom: '12px' }}>Rastreamento (UTMs)</h3>
        
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '24px' }}>
          <div>
            <p style={{ color: 'var(--text-secondary)', fontSize: '0.875rem', marginBottom: '4px' }}>Origem</p>
            <p style={{ fontWeight: 500 }}>{lead.origem || '-'}</p>
          </div>
          <div>
            <p style={{ color: 'var(--text-secondary)', fontSize: '0.875rem', marginBottom: '4px' }}>UTM Source</p>
            <p style={{ fontWeight: 500 }}>{lead.utm_source || '-'}</p>
          </div>
          <div>
            <p style={{ color: 'var(--text-secondary)', fontSize: '0.875rem', marginBottom: '4px' }}>UTM Medium</p>
            <p style={{ fontWeight: 500 }}>{lead.utm_medium || '-'}</p>
          </div>
          <div>
            <p style={{ color: 'var(--text-secondary)', fontSize: '0.875rem', marginBottom: '4px' }}>UTM Campaign</p>
            <p style={{ fontWeight: 500 }}>{lead.utm_campaign || '-'}</p>
          </div>
        </div>
      </div>
    </div>
